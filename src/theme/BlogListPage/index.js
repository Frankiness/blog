...
function BlogListPage(props) {
  ...
  const description = `不仅仅是前端工程师，分享Vue.js, HTML, CSS, JavaScript, Node.js 技术以及个人发展、自我提升相关的心得`;
    ...
    <Layout title={title} description={description}>
      ...
      <div className="hero">
        ...
        <div className="bloghome__image">
          <animated.img src="/img/cloud.jpg" style={animatedHero} />
        </div>
        {/* <animated.div
...
function SocialLinks({ animatedProps, ...props }) {
  ...
  return (
    <animated.div className="social__links" style={animatedProps}>
      <a href="https://space.bilibili.com/45269198">
        <img
      ...
      <a href="https://github.com/Frankiness">
      ...
      <div class="dropdown dropdown--hoverable">
        ...
        <img
          ...
          src={useBaseUrl("/img/publicWeixin.jpg")}
        />
      </div>
    </animated.div>
  );
